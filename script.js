 ...
 * Persists user preference via localStorage and syncs with system theme
 */
function initTheme() {
  const toggleButtons = document.querySelectorAll('.theme-toggle-btn');
  const storedTheme = localStorage.getItem('ai_learning_ph_theme');
  ...
  toggleButtons.forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      localStorage.setItem('ai_learning_ph_theme', newTheme);
